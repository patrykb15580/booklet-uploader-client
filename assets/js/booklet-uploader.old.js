var BookletUploaderOld = (function($) {
    var plugin = {};
    var self = {};
    ...
    plugin.init = function(api) {
        ...
        plugin.openEditor = function(file_hash_id, options) {
            ...
            image.setSrc = function(src) {
                src = src.replace('http://kreator.fotobum.test', 'http://192.168.1.131:8080');
            ...
            var _Cropper = function() {
                ...
                _Request('transform', data).done(function(response) {
                    ...
                    url = file.attributes.original_url.replace('http://kreator.fotobum.test', 'http://192.168.1.131:8080');

                    cimg.src = url + modifiers;
                }).fail(function() {
                    _error(_locale('errors.load_file'));
                });
